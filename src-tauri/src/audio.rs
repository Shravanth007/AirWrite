...
impl AudioRecorder {
    ...
    pub fn start(&mut self, mic_name: &str) -> Result<(), String> {
        ...
        println!("[AirWrite] Mic config: {}Hz, {} channels", sample_rate, channels);
        ...
        let stream = device
            .build_input_stream(
                ...
                |err| {
                    eprintln!("[AirWrite] Audio stream error: {}", err);
                },
                None,
            )
            .map_err(|e| e.to_string())?;
    ...
    pub fn stop_and_save(&mut self, output_path: &PathBuf) -> Result<PathBuf, String> {
        ...
        println!("[AirWrite] Captured {} raw samples", samples.len());
        ...
        println!("[AirWrite] Resampled to {} samples at 16kHz", resampled.len());
        ...
        println!("[AirWrite] WAV saved to {:?}", output_path);
